      ...
      <div className="contacto__wrapper">          
          ...
          <div className="contacto__info">
              <h3 className="contacto__titulo-wrapper">Información</h3>
                <p className="contacto__info-p">< BsGeoAlt className='icon icon-geo'/>En todo el pais</p>
                <p className="contacto__info-p">< HiOutlineMail className='icon icon-email'/>@gmail.com</p>
