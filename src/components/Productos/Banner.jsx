...
function Banner({ greeting, data }) {
  return (
    <div className="App" style={{ marginTop: "120px" }}>
      <div className="swiperContainer">
        ...
        >
          <SwiperSlide className="slider">
            <img src="/assets/First.webp" alt="Clothing" className="banner" />
          </SwiperSlide>
          <SwiperSlide className="slider">
      ...
      <h1 style={{ margin: "70px 0 30px" }}>¡Bienvenida a Traki!</h1>

      <div className="aviso">
        <div className="aviso__conte">
          <RiShoppingCart2Line style={{ fontSize: "40px" }} />
          <Aviso text="Una vez confirmado el stock, nos comunicamos por whatsapp dentro de 16 horas hábiles.">
            REALIZÁ TU PEDIDO
          </Aviso>
        </div>
        <div className="aviso__conte">
          <MdPayment style={{ fontSize: "40px" }} />
          <Aviso text="Aboná tu pedido en 48 HRS HÁBILES por depósito, transferencia, mercadopago, o efectivo en el local.">
            REALIZÁ EL PAGO
          </Aviso>
        </div>
        <div className="aviso__conte">
          <TbTruckDelivery style={{ fontSize: "40px" }} />
          <Aviso text="Retirá tu pedido en nuestras franquicias alrededor de todo el pais.">
            RECIBÍ TU PEDIDO
          </Aviso>
        </div>
      </div>
      ...
      <div className="categoria">
        <div className="categoria__imagen">
          ...
          <div className="categoria__btn-l">
            <Link to="/categoria/Pantalón">
              <Boton2 text="Pantalón" className="boton__categoria"></Boton2>
            </Link>
          </div>
        </div>
        <div className="categoria__imagen">
          ...
          <div className="categoria__btn-r">
            <Link to="/categoria/Remera">
              <Boton2 text="Remera" className="boton__categoria"></Boton2>
            </Link>
          </div>
        </div>
      </div>
        ...
        <div className="loNvo">
            ...
            <div>
              <div className="card__detail">
                ...
                <div className="card__prefa">
                  ...
                  <button className="card__favorito">
                    <IoMdHeartEmpty />
                  </button>
                </div>
              </div>
          ...
          <section className="card">
            <Link to={`/productos/gOGiPe77BAXyvP8BG2nb`}>
              <div>
                <img
                  src="/assets/chupinbengalinaconlazo.jpg"
                  alt="Chupin Bengalina con Lazo"
                  className="card__img"
                />
              </div>
            </Link>
